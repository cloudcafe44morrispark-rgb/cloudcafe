        ...
        <div className="mb-6 p-4 bg-amber-50 rounded-xl border border-amber-200 text-left">
            <div className="flex items-start gap-3 mb-3">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-600">
                        A phone number is required so we can contact you about this order. The kitchen ticket prints after you save.
                    </p>
                </div>
            </div>
            <form onSubmit={handleSave} className="space-y-3">
                ...
                <button
                    type="submit"
                    disabled={saving}
                    className="w-full inline-flex items-center justify-center gap-2 px-4 py-2 bg-[#B88A68] text-white font-semibold rounded-lg hover:bg-[#A67958] disabled:opacity-50"
                >
